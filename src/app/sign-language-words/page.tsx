      ...
      <main>
        ...
        <div id="vr-wrapper-main">
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/mom-in-sign-language.webp" alt="Teen girl signing MOM in American Sign Language with open hand thumb touching chin" className="vr-card-image" width={540} height={540} decoding="async" />
          ...
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/dad-in-sign-language.webp" alt="Girl demonstrating DAD in American Sign Language with open hand raised to forehead" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
        ...
        <div id="vr-wrapper-main">
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/help-in-sign-language.webp" alt="Girl showing HELP sign in ASL with thumbs-up hand resting on open flat palm" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
          ...
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/have-a-good-day-in-sign-language.webp" alt="Child signing Have a Good Day in ASL with crossed arms and index finger pointing outward" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
        ...
        <div id="vr-wrapper-main">
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/hi-in-american-sign-language.webp" alt="Woman demonstrating HI in American Sign Language with open flat hand raised beside face" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
          ...
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/how-are-you-in-asl.webp" alt="Man signing How Are You in ASL with both thumbs up facing outward" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
        ...
        <div id="vr-wrapper-main">
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/more-in-sign-language.webp" alt="Child demonstrating MORE in ASL by bringing both pinched hands together at fingertips" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
          ...
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/i-love-you-in-sign-language.webp" alt="Girl making I Love You handshape in ASL with pinky, index finger, and thumb extended" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
        ...
        <div id="vr-wrapper-main">
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/wait-in-sign-language.webp" alt="Girl showing WAIT in ASL with one hand on chest and other hand open palm facing up" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
          ...
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/please-in-sign-language.webp" alt="Woman signing PLEASE in ASL with flat hand rubbing circular motion on chest" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
        ...
        <div id="vr-wrapper-main">
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/what-in-asl.webp" alt="Woman demonstrating WHAT in American Sign Language with both palms open and spread outward" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
          ...
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/youe-welcome-in-sign-language.webp" alt="Woman signing YOU'RE WELCOME in ASL with flat hand moving forward from chin outward" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
          ...
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/happy-birthday-in-sign-language.webp" alt="Man demonstrating Happy Birthday in American Sign Language ASL with two-step hand gestures" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
          ...
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/family-sign-language.webp" alt="Person showing Family sign in ASL forming F-handshapes in a circle with both hands" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
          ...
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/sorry-sign-language.webp" alt="Child demonstrating Sorry in ASL with closed fist making circular motion on chest" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
          ...
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/all-done-sign-language.webp" alt="Man signing All Done in ASL with both open palms facing outward at chest level" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
          ...
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/hello-in-sign-langauge.webp" alt="Smiling girl demonstrating Hello in ASL with flat hand salute moving away from forehead" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
          ...
          <div className="vr-single-card">
            ...
            <img src="/sign-language-words/no-sign-language.webp" alt="Boy showing No sign in American Sign Language ASL with index and middle fingers tapping thumb" className="vr-card-image" width={540} height={540} loading="lazy" decoding="async" />
            <div className="vr-content-box">
              <p className="main-title">
